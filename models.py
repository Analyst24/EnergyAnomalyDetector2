...
try:
    ...
    st.warning("TensorFlow is not properly configured. Autoencoder model will not be available.")
...
def autoencoder_model(data, epochs=50, batch_size=32, contamination=0.05):
    ...
    if not tensorflow_available:
        st.error("Autoencoder model requires TensorFlow, which is not properly configured.")
